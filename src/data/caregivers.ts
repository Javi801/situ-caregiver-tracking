...
export const caregivers: Caregiver[] = [
  {
    ...
    distanceKm: 3.2,
    etaMinutes: 18,
    certifications: ["Cuidado de adultos mayores", "Primeros auxilios"],
    availableFrom: "08:00",
  ...
  },
  {
    ...
    distanceKm: 5.8,
    etaMinutes: 24,
    certifications: ["Cuidado de adultos mayores", "Apoyo en demencia"],
    availableFrom: "07:30",
  ...
  },
  {
    ...
    distanceKm: 2.1,
    etaMinutes: 14,
    certifications: ["Cuidado de adultos mayores"],
    availableFrom: "09:00",
  ...
  },
  {
    ...
    distanceKm: 9.4,
    etaMinutes: 33,
    certifications: ["Cuidado de adultos mayores", "Asistencia de movilidad"],
    availableFrom: "08:00",
